...
-- (2019.09.27) - 생성일자, 생성자, 수정일자, 수정자, 썸네일URL, 카테고리, DESCRIPTION 추가
...
-- ALTER TABLE APM_APP  ADD COLUMN CATEGORY VARCHAR(50);
-- ALTER TABLE APM_APP  ADD COLUMN THUMBNAIL_URL VARCHAR(256);
-- ALTER TABLE APM_APP  ADD COLUMN DESCRIPTION TEXT;
-- ALTER TABLE APM_APP  ADD COLUMN CREATED_BY VARCHAR(100);
-- ALTER TABLE APM_APP  ADD COLUMN CREATED_TIME TIMESTAMP;
-- ALTER TABLE APM_APP  ADD COLUMN UPDATED_BY VARCHAR(100);
-- ALTER TABLE APM_APP  ADD COLUMN UPDATED_TIME TIMESTAMP;

-- APP_TIER 추가 
-- (2019.10.15) - TAG 테이블 추가
CREATE TABLE IF NOT EXISTS APM_APP_TAG (
