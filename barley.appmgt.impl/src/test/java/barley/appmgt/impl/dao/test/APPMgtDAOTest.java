...
public class APPMgtDAOTest extends TestCase {
	...
	protected void setUp() throws Exception {
		// 시스템변수 설정
		System.setProperty(ServerConstants.CARBON_HOME, "D:\\Workspace_STS_APPM\\barley.appmgt\\barley.appmgt.impl\\src\\test\\resources\\");
		System.setProperty("AppManagerDBConfigurationPath", 
				"D:\\Workspace_STS_APPM\\barley.appmgt\\barley.appmgt.impl\\src\\test\\resources\\amConfig.xml");
		System.setProperty("IdentityConfigurationPath", 
				"D:\\Workspace_STS_APPM\\barley.appmgt\\barley.appmgt.impl\\src\\test\\resources\\identity.xml");
		...
		ServiceReferenceHolder.getInstance()
		                      .setAPIManagerConfigurationService(new AppManagerConfigurationServiceImpl(
		                                                                                                config));
		// DataSource 설정이 있으면 nslookup으로 가져오고 없다면 DataSource를 생성한다.
