 ...
 *  distributed under the LicensAPIManagerConfigurationServicee is distributed on an "AS IS" BASIS,
...
/**
 * Service interface for retrieving the current AppManagerConfiguration.
 */
