...
import barley.appmgt.api.AppMgtAuthorizationFailedException;
import barley.appmgt.api.AppMgtResourceAlreadyExistsException;
import barley.appmgt.api.AppMgtResourceNotFoundException;
...
import barley.appmgt.impl.utils.TierNameComparator;
...
import barley.registry.core.secure.AuthorizationFailedException;
    ...
    public List<Documentation> getAllDocumentation(APIIdentifier appId) throws
        ...
        try {
            ...
            for (Association association : docAssociations) {
                ...
                // (추가) 2018.03.15 - GovernanceUtils.artifactConfigurations가 공백이라 load를 수행해야 configurations가 로드된다.
                // (수정) AppManagerUtil.getArtifactManager(registry, AppMConstants.DOCUMENTATION_KEY); 로 수정 
...
//                                                                                    AppMConstants.DOCUMENTATION_KEY);
    ...
    public List<Documentation> getAllDocumentation(APIIdentifier apiId,String loggedUsername) throws
        ...
        try {
            ...
            barley.user.api.AuthorizationManager manager = null;
...
//                identifier.getProviderName() +
    ...
    public List<String> getDocumentationFileNames(APIIdentifier apiId) throws AppManagementException {
    	...
    	String docPath = AppManagerUtil.getAPIDocPath(apiId) + AppMConstants.DOCUMENT_FILE_DIR;
    	try {
...
//                              identifier.getProviderName() + 
    ...
    /**
     * Returns a list of pre-defined # {@link barley.appmgt.api.model.Tier} in the system.
     *
     * @return Set<Tier>
     */
