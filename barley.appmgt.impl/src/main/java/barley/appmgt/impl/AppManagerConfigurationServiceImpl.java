...
public class AppManagerConfigurationServiceImpl implements AppManagerConfigurationService {
    ...
    public AppManagerConfigurationServiceImpl(AppManagerConfiguration configuration) {
        this.configuration = configuration;
    }
    public AppManagerConfigurationServiceImpl(AppMgtXACMLPolicyTemplateReader XACMLPolicyReader) {
        this.XACMLPolicyReader = XACMLPolicyReader;
    }
