 ...
 */
package barley.appmgt.impl.listners;
...
import barley.user.core.common.AbstractUserStoreManagerListener;
import barley.user.core.listener.AuthorizationManagerListener;
...
public class UserAddListener extends AbstractUserStoreManagerListener {
    ...
    public boolean addUser(String userName, Object credential, String[] roleList,
        ...
        try {
            ...
            String configs = BarleyUtils.getCarbonConfigDirPath() + "/apimanager/bpel-policy.xml";
