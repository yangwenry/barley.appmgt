...
import barley.appmgt.impl.idp.sso.SSOConfiguratorConstants;
        ...
        for (Iterator childElements = serverConfig.getChildElements(); childElements
            ...
            if (elementHasText(element)) {
                ...
                while(environmentIterator.hasNext()){
                    ...
                    // (추가) 2018.03.23 - 포트로 인해 설정값 추가 
                    environment.setApiServiceEndpoint(replaceSystemProperty(
                            environmentElem.getFirstChildWithName(new QName(
                                    AppMConstants.API_SERVICE_ENDPOINT)).getText()));
