...
public class AppMgtResourceNotFoundException extends AppManagementException {
    ...
    public AppMgtResourceNotFoundException(String msg) {
        super(msg);
    }

    public AppMgtResourceNotFoundException(String msg, Throwable e) {
        super(msg, e);
    }

    public AppMgtResourceNotFoundException(Throwable throwable) {
        super(throwable);
    }
}
