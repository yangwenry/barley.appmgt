...
/**
 * Interface through which WebApp consumers are authenticated. An implementation of this interface
...
public interface Authenticator {
    ...
    /**
     * Authenticates the given request to see if an WebApp consumer is allowed to access
     * a particular WebApp or not. If the request can be properly authenticated, this method
     ...
     * to the WebApp consumer in the form of a WWW-Authenticate header.
     *
