...
/**
 * Use this factory implementation to construct the required WebApp key caches. This class
...
public class APIKeyCacheFactory {
    ...
    /**
     * This method checks whether an APIKeyCache instance exists for the specified WebApp
     ...
     *
     * @param context An WebApp context
    ...
    /**
     * This method returns an existing APIKeyCache instance for the given WebApp context, version
