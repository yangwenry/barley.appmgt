...
public class APIKeyValidationService {
  ...
  public interface Iface {
    ...
    public APIKeyValidationInfoDTO validateKey(String context, String version, String accessToken, String sessionId, String requiredAuthenticationLevel, String clientDomain) throws APIKeyMgtException,
                                                                                                                                                                                     AppManagementException, org.apache.thrift.TException;
     public List<URITemplate> getAllURITemplates(String context, String apiVersion, String sessionId) throws
                                                                                                         barley.appmgt.gateway.handlers.security.thrift.APIKeyMgtException,
                                                                                                         AppManagementException, org.apache.thrift.TException,
                                                                                       APIKeyMgtException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public APIKeyValidationInfoDTO recv_validateKey() throws APIKeyMgtException,
                                                             AppManagementException, org.apache.thrift.TException
    {
      ...
      if (result.appMgtException != null) {
        throw result.appMgtException;
      }
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class validateKey_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public APIKeyValidationInfoDTO getResult() throws APIKeyMgtException, AppManagementException, org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    private static class validateKey<I extends Iface> extends org.apache.thrift.ProcessFunction<I, validateKey_args> {
      ...
      public validateKey_result getResult(I iface, validateKey_args args) throws org.apache.thrift.TException {
        ...
        } catch (AppManagementException appMgtException) {
          result.appMgtException = appMgtException;
        }
        return result;
      }
      ...
      private static class getAllURITemplates<I extends Iface>
          ...
          public getAllURITemplates_result getResult(I iface, getAllURITemplates_args args)
              ...
              } catch (barley.appmgt.gateway.handlers.security.thrift.APIKeyMgtException apiKeyMgtException) {
                  result.apiKeyMgtException = apiKeyMgtException;
              } catch (AppManagementException appMgtException) {
                  result.appMgtException = appMgtException;
              }
  ...
  public static class validateKey_result implements org.apache.thrift.TBase<validateKey_result, validateKey_result._Fields>, java.io.Serializable, Cloneable   {
    ...
    private static final org.apache.thrift.protocol.TField API_MGT_EXCEPTION_FIELD_DESC = new org.apache.thrift.protocol.TField("appMgtException", org.apache.thrift.protocol.TType.STRUCT, (short)2);
    ...
    public AppManagementException appMgtException; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      SUCCESS((short)0, "success"),
      API_KEY_MGT_EXCEPTION((short)1, "apiKeyMgtException"),
      API_MGT_EXCEPTION((short)2, "appMgtException");
    ...
    static {
      ...
      tmpMap.put(_Fields.API_MGT_EXCEPTION, new org.apache.thrift.meta_data.FieldMetaData("appMgtException", org.apache.thrift.TFieldRequirementType.DEFAULT,
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public validateKey_result(
      ...
      AppManagementException appMgtException)
    {
      this();
      this.success = success;
      this.apiKeyMgtException = apiKeyMgtException;
      this.appMgtException = appMgtException;
    }
    ...
    public validateKey_result(validateKey_result other) {
      ...
      if (other.isSetApiMgtException()) {
        this.appMgtException = new AppManagementException(other.appMgtException);
      }
    }
    ...
    public AppManagementException getApiMgtException() {
      return this.appMgtException;
    }

    public validateKey_result setApiMgtException(AppManagementException appMgtException) {
      this.appMgtException = appMgtException;
      return this;
    }
    ...
    /** Returns true if field appMgtException is set (has been assigned a value) and false otherwise */
    public boolean isSetApiMgtException() {
      return this.appMgtException != null;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case API_MGT_EXCEPTION:
        if (value == null) {
          ...
          setApiMgtException((AppManagementException)value);
        }
        break;
    ...
    public boolean equals(validateKey_result that) {
      ...
      if (this_present_apiMgtException || that_present_apiMgtException) {
        if (!(this_present_apiMgtException && that_present_apiMgtException))
          return false;
        if (!this.appMgtException.equals(that.appMgtException))
          return false;
      }
    ...
    public int compareTo(validateKey_result other) {
      ...
      if (isSetApiMgtException()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.appMgtException, typedOther.appMgtException);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public String toString() {
      ...
      first = false;
      if (!first) sb.append(", ");
      sb.append("appMgtException:");
      if (this.appMgtException == null) {
        sb.append("null");
      } else {
        sb.append(this.appMgtException);
      }
      first = false;
      sb.append(")");
      return sb.toString();
    ...
    private static class validateKey_resultStandardScheme extends StandardScheme<validateKey_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, validateKey_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 2: // API_MGT_EXCEPTION
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.appMgtException = new AppManagementException();
                struct.appMgtException.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, validateKey_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.appMgtException != null) {
          oprot.writeFieldBegin(API_MGT_EXCEPTION_FIELD_DESC);
          struct.appMgtException.write(oprot);
          oprot.writeFieldEnd();
        }
        oprot.writeFieldStop();
        oprot.writeStructEnd();
    ...
    public static class getAllURITemplates_args implements org.apache.thrift.TBase<getAllURITemplates_args, getAllURITemplates_args._Fields>, java.io.Serializable, Cloneable   {
        ...
        public enum _Fields implements org.apache.thrift.TFieldIdEnum {
            CONTEXT((short)1, "context"),
            APP_VERSION((short)2, "apiVersion"),
        ...
        static {
            ...
            tmpMap.put(_Fields.CONTEXT, new org.apache.thrift.meta_data.FieldMetaData("context", org.apache.thrift.TFieldRequirementType.REQUIRED,
                                                                                      new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
            tmpMap.put(_Fields.APP_VERSION, new org.apache.thrift.meta_data.FieldMetaData("apiVersion", org.apache.thrift.TFieldRequirementType.REQUIRED,
                                                                                          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
            tmpMap.put(_Fields.SESSION_ID, new org.apache.thrift.meta_data.FieldMetaData("sessionId", org.apache.thrift.TFieldRequirementType.REQUIRED,
                                                                                         new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
            metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public static class getAllURITemplates_result implements org.apache.thrift.TBase<getAllURITemplates_result, getAllURITemplates_result._Fields>, java.io.Serializable, Cloneable   {
        ...
        public barley.appmgt.gateway.handlers.security.thrift.APIKeyMgtException apiKeyMgtException; // required
        public AppManagementException appMgtException; // required
        ...
        public getAllURITemplates_result(
                ...
                barley.appmgt.gateway.handlers.security.thrift.APIKeyMgtException apiKeyMgtException,
                AppManagementException appMgtException)
        {
            this();
            this.success = success;
        ...
        public getAllURITemplates_result(getAllURITemplates_result other) {
            ...
            if (other.isSetApiKeyMgtException()) {
                this.apiKeyMgtException = new barley.appmgt.gateway.handlers.security.thrift.APIKeyMgtException(other.apiKeyMgtException);
            }
            if (other.isSetApiMgtException()) {
                this.appMgtException = new AppManagementException(other.appMgtException);
            }
        ...
        public barley.appmgt.gateway.handlers.security.thrift.APIKeyMgtException getApiKeyMgtException() {
            return this.apiKeyMgtException;
        }
        ...
        public getAllURITemplates_result setApiMgtException(AppManagementException appMgtException) {
            this.appMgtException = appMgtException;
            return this;
        }
            ...
            switch (field) {
                ...
                case API_KEY_MGT_EXCEPTION:
                    if (value == null) {
                        ...
                        setApiKeyMgtException((barley.appmgt.gateway.handlers.security.thrift.APIKeyMgtException)value);
                    }
                    break;
            ...
            public void read(org.apache.thrift.protocol.TProtocol iprot, getAllURITemplates_result struct) throws org.apache.thrift.TException {
                ...
                while (true)
                {
                    ...
                    switch (schemeField.id) {
                        ...
                        case 1: // API_KEY_MGT_EXCEPTION
                            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                                struct.apiKeyMgtException = new barley.appmgt.gateway.handlers.security.thrift.APIKeyMgtException();
                                struct.apiKeyMgtException.read(iprot);
                                struct.setApiKeyMgtExceptionIsSet(true);
                            } else {
                                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
