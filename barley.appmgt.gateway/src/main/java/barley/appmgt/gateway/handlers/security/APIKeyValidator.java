...
import barley.appmgt.gateway.handlers.security.keys.WSAPIKeyDataStore;
import barley.appmgt.gateway.handlers.security.thrift.ThriftAPIDataStore;
...
/**
 * This class is used to validate a given WebApp key against a given WebApp context and a version.
 ...
 * caches some WebApp key authentication information in memory. This implementation and the
 * underlying caching implementation are thread-safe. An instance of this class must not be
 * shared among multiple APIs, WebApp handlers or authenticators.
 */
public class APIKeyValidator {
    ...
    /**
     * Get the WebApp key validated against the specified WebApp
     *
     * @param context    WebApp context
     * @param apiKey     WebApp key to be validated
     * @param apiVersion WebApp version number
    ...
    public APIKeyValidationInfoDTO getKeyValidationInfo(String context, String apiKey,
        ...
        // We synchronize on the WebApp key here to allow concurrent processing
        // of different WebApp keys - However when a burst of requests with the
        ...
        if (info != null) {
            ...
            throw new APISecurityException(APISecurityConstants.API_AUTH_GENERAL_ERROR,
                    "WebApp key validator returned null");
        }
        //}
    }
...
//            }
    ...
    /**
     * @param context     WebApp context of WebApp
     * @param apiVersion  Version of WebApp
