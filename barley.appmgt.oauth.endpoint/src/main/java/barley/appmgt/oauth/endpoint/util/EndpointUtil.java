package barley.appmgt.oauth.endpoint.util;
...
import barley.identity.oauth2.model.OAuth2Parameters;
...
public class EndpointUtil {
    ...
    public static AppManagerOAuth2Service getOAuth2Service() {
        return (AppManagerOAuth2Service) PrivilegedBarleyContext.getThreadLocalCarbonContext()
    ...
    public static OAuthServerConfiguration getOAuthServerConfiguration() {
        return (OAuthServerConfiguration) PrivilegedBarleyContext.getThreadLocalCarbonContext()
    ...
    public static OAuth2TokenValidationService getOAuth2TokenValidationService() {
        return (OAuth2TokenValidationService) PrivilegedBarleyContext.getThreadLocalCarbonContext()
